...
var Transfer = (function ($) {
    ...
    function transfer(settings) {
        ...
        $(transferId).find(tabItemName).on("click", function () {
            ...
            if (!$(this).is(".tab-active")) {
                ...
                // 清空右侧数量
                $(transferId).find(selectedTotalNum).text("共0项");
                // 未选中项
                if ($(transferId).find(tabContentFirst).css("display") != "none") {
                    ...
                    $(transferId).find(groupTotalNum).empty();
                    $(transferId).find(groupTotalNum).append("共" + $(transferId).find(transferDoubleGroupListLiUlLi).length + "项");
                } else {
                    // 分组
        ...
        $(addSelected).on("click", function () {
            ...
            if ($(transferId).find(tabContentFirst).css("display") != "none") {
                ...
                // 右侧数量
                $(transferId).find(selectedTotalNum).text("共" + selected_total_num + "项");
    ...
    function generateTransfer(inputId, currentTimeStr) {
        var htmlStr =
            ...
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + ' tab-active">未选中分组</div>'
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + '">未选中项</div>'
            + '</div>'
            ...
            + '<input class="transfer-double-list-search-input" type="text" id="groupListSearch_' + currentTimeStr + '" placeholder="搜索" value="" />'
            + '</div>'
            + '</div>'
            ...
            + '<input class="transfer-double-selected-list-search-input" type="text" id="selectedListSearch_' + currentTimeStr + '" placeholder="搜索" value="" />'
            + '</div>'
            + '</div>'
            ...
            + '</div>'
            + '<div class="transfer-double-list-footer">'
            + '<label class="selected_total_num_' + currentTimeStr + '">共0项</label>'
            + '</div>'
            + '</div>'
            + '</div>'
            + '</div>'
